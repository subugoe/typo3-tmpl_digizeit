...
ul.quicklinks {
	...
	padding: 4px;
	text-align: left;
	border-bottom: 2px solid #8b0716;
	border-top: 2px solid #8b0716;
	clear: left;
}
ul.quicklinks li {
	display: inline;
...
<html>
  <head>
    <title>DigiZeitschriften.de - OAI 2.0 Request Results</title>
    <style><xsl:call-template name="style"/></style>
  </head>
  <body>
    <h1>www.digizeitschriften.de</h1>
...
<xsl:template match="oai:header">
  ...
  <table class="values">
    ...
    <td class="value">
      ...
      <xsl:text> </xsl:text><a class="link" href="http://dfg-viewer.de/v2?set[mets]=http%3A%2F%2Fwww.digizeitschriften.de%2Fmain%2Fdms%2Fmetsresolver%2F%3FPPN%3D{substring(oai:identifier,30)}">DFG-Viewer</a>
